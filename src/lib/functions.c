...
int *combine_ranges(int *ranges_r1, int *ranges_r2, int size_of_array) {
  ...
  int c_r1 = 0;
  int c_r2 = 0;
  while(stops_r1[c_r1]!=-1 || stops_r2[c_r2]!=-1)
  {
    if ((starts_r1[c_r1] < starts_r2[c_r2] || stops_r2[c_r2] == -1) && stops_r1[c_r1]!=-1) {
      a[c_a] = starts_r1[c_r1];
      if (stops_r1[c_r1] <= starts_r2[c_r2] || stops_r2[c_r2] == -1) {
    ...
    } else if (stops_r2[c_r2]!=-1) {
      a[c_a] = starts_r2[c_r2];
      if (stops_r2[c_r2] <= starts_r1[c_r1] || stops_r1[c_r1] == -1) {
        a[c_a + 1] = stops_r2[c_r2];
        c_a = c_a + 2;
        if (c_r2 < size_of_array/2) c_r2++;
      } else {
  ...
  log_info("got here combine_ranges!");
  //for (int i = 0; i < size_of_array; i++) {
...
void update_coverage(int *ranges, Entry *entry, Genome *genome, int size_of_array){
  ...
  for (int l = 0; l < size_of_array/2; l++) {
      log_info("Ranges l %d:   %d", l, ranges[l]);
  }
...
int add_reads_to_cov(char *r1_line, char *r2_line, Genome *genome,
  ...
  log_info("LALA ranges_r1 %d", ranges_r1[0]);

  int *ranges_r2;
  ranges_r2 = interpret_cigar_string(entry_r2,size_of_array);
  log_info("LALA ranges_r2 %d", ranges_r2[0]);
...
int compare_two_files(char *file1, char *file2) {
  ...
  char line1[5000];
  char line2[5000];
  log_info("sizeof line1 %lu", sizeof(line1));
  log_info("sizeof line2 %lu", sizeof(line2));
  while (fgets( line1, sizeof(line1), file_handler1) != NULL)
  {
    log_info("Line1 %s", line1);
    //fgets(line2, sizeof(line2) , file_handler2);
    if (fgets( line2, sizeof(line2), file_handler2 ) != 0) {
